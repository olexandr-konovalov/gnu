...
GNU_SAVE( 2304, 15756130, "https://doi.org/10.1016/j.jalgebra.2013.09.028" );
...
GNU_SAVE( 6048, 36021, WITH_GC );
GNU_SAVE( 6080, 10743, WITH_GC );
GNU_SAVE( 6102, 30, WITH_GC );
GNU_SAVE( 6125, 10, WITH_GC );
GNU_SAVE( 6318, 1584, WITH_GC );
GNU_SAVE( 6240, 9304, WITH_GC );
...
GNU_SAVE( 6720, 106765, WITH_GC );
GNU_SAVE( 6804, 5981, WITH_GC );
...
GNU_SAVE( 7290, 3623, WITH_GC );
GNU_SAVE( 7344, 3459, WITH_GC );
GNU_SAVE( 7360, 10743, WITH_GC );
...
GNU_SAVE( 7616, 10915, WITH_GC );
GNU_SAVE( 7744, 8019, WITH_GC );
GNU_SAVE( 7749, 13, WITH_GC );
GNU_SAVE( 7803, 19, WITH_GC );
GNU_SAVE( 7840, 5513, WITH_GC );
GNU_SAVE( 7872, 11415, WITH_GC );
GNU_SAVE( 7875, 30, WITH_GC );
GNU_SAVE( 7920, 4186, WITH_GC );
...
GNU_SAVE( 10584, 5921, WITH_GC );
GNU_SAVE( 10692, 2023, WITH_GC );
GNU_SAVE( 10976, 4166, WITH_GC );
GNU_SAVE( 11088, 3961, WITH_GC );
GNU_SAVE( 11250, 375, WITH_GC );
GNU_SAVE( 11340, 2487, WITH_GC );
GNU_SAVE( 12000, 40092, WITH_GC );
GNU_SAVE( 12150, 2487, WITH_GC );
GNU_SAVE( 14640, 1500, WITH_GC );
GNU_SAVE( 15000, 3747, WITH_GC );
GNU_SAVE( 15120, 22758, WITH_GC );
GNU_SAVE( 16875, 123, WITH_GC );
GNU_SAVE( 16928, 922, WITH_GC );
GNU_SAVE( 17424, 3682, WITH_GC );
GNU_SAVE( 17500, 531, WITH_GC );
GNU_SAVE( 17640, 4066, WITH_GC );
GNU_SAVE( 18480, 5397, WITH_GC );
GNU_SAVE( 20304, 2919, WITH_GC );
GNU_SAVE( 21840, 8254, WITH_GC );
GNU_SAVE( 25488, 2919, WITH_GC );
GNU_SAVE( 28560, 5487, WITH_GC );
GNU_SAVE( 32736, 6834, WITH_GC );
GNU_SAVE( 39304, 245, WITH_GC );
GNU_SAVE( 39375, 93, WITH_GC );
GNU_SAVE( 39546, 304, WITH_GC );
GNU_SAVE( 42840, 2970, WITH_GC );
GNU_SAVE( 48840, 908, WITH_GC );
GNU_SAVE( 49560, 612, WITH_GC );
